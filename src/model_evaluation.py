...
def evaluate_model(clf, X_test, y_test):
    ...
    try:
        ...
        logger.debug('Model evaluated with accuracy: %s, precision: %s, recall: %s, auc: %s', accuracy, precision, recall, auc)
        return matrics_dict
    except Exception as e:
...
def save_metrics(metrics: dict, file_path: str):
    ...
    try:
        ...
        logger.error('Failed to save the metrics: %s', e)
        raise


def main():
    try:
        params=load_params(params_path=r'C:\Users\saheb\Desktop\complete_machine_learning _pipeline\params.yaml')
